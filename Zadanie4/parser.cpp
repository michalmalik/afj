...
#line 41 "jazyk.y"
    {
				...
				sem->reduceExpression(*(yyvsp[(1) - (3)].string));
			}
    break;
...
#line 56 "jazyk.y"
    {
				...
				sem->reduceExpression(*(yyvsp[(1) - (2)].string));
			}
    break;
...
#line 85 "jazyk.y"
    {
				...
				sem->reduceExpression(*(yyval.string));
			}
    break;
